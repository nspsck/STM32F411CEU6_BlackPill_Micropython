#define MICROPY_HW_BOARD_NAME       "WeAct Studio Blackpill v3.1"
...
// Peripheral clock divider. In case you want default peripheral speed.
// These settings will be overwritten once you call pyb.freq() or machine.freq()
